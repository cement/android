 ...
 */
public class MultiAnimationActivity extends Activity {
	...
	public class MyAnimationView extends View implements AnimatorUpdateListener  {
		...
		private void createAnimation() {
			if (bounceAnim == null) {
				ShapeHolder ball;
				ball = balls.get(0);
				ObjectAnimator yBouncer = ObjectAnimator.ofFloat(ball, "y", ball.getY(), getHeight() - BALL_SIZE).setDuration(DURATION);
